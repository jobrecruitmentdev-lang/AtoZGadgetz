...
export declare const paypalCreateOrder: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const paypalCaptureOrder: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
