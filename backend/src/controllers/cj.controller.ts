...
export const searchCjProducts = async (req: Request, res: Response) => {
  try {
...
export const getCjProductDetail = async (req: Request, res: Response) => {
  try {
...
export const importCjProduct = async (req: Request, res: Response) => {
  try {
    ...
    const product = await CjProductService.importProduct(
      cjPid,
      Number(categoryId),
      Number(subcategoryId),
      Number(markupPercentage || 2.0),
    );
...
export const placeCjOrder = async (req: Request, res: Response) => {
  try {
...
export const cancelCjOrder = async (req: Request, res: Response) => {
  try {
...
export const syncAllShipments = async (_req: Request, res: Response) => {
  try {
