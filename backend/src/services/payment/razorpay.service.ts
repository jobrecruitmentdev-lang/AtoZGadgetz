...
export class RazorpayService {
  private static readonly KEY_ID = process.env.RAZORPAY_KEY_ID || '';
  private static readonly KEY_SECRET = process.env.RAZORPAY_KEY_SECRET || '';
  ...
  static async createOrder(amount: number, currency: 'INR' | 'USD', receipt: string) {
    ...
    const response = await axios.post(
      ...
      { amount: amountInSmallest, currency, receipt },
